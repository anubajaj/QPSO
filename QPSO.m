...
disp('The Particle Swarm Algorithm is optimizing the problem...')
...
for iterations=1:Max_Iterations
    ...
    disp(['Iteration ' num2str(iterations) ': Best_Fitness = ' num2str(Best_Fitness(iterations))]);
   % figure, plot(iterations,gBest_Fitness_EachItr); xlabel('Number of Iterations'); ylabel('Fitness Values'); title('IQPSO Convergence curve');     
